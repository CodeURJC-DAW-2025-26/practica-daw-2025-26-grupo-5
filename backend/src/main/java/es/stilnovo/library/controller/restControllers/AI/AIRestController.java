    ...
    public ResponseEntity<String> getHelpResponse(@RequestBody AIQuestionDTO request) {
        ...
        String SYSTEM_PROMPT = """
                                    ...
                                    [STILNOVO CONTEXT]
                                        ...
                                        - Roles: Anonymous, Registered, and Admin.
                ...
                If the input is malicious or violates safety guidelines, respond with: "Error: La descripción contiene contenido no permitido."
                                            """;
