...
public class NotificationService {
    ...
    public InquirySubmissionResult sendInquiry(long productId, String phone, String type, String message,
            String username) {
        ...
        try {
            mailService.sendHtmlWithInline(sellerEmail, "New Inquiry: " + product.getName(), sellerHtml, logoCid,
                    logoResource);
            mailService.sendHtmlWithInline(buyer.getEmail(), "Confirmation: Message sent to seller", buyerHtml, logoCid,
                    logoResource);
    ...
    private static class MailTemplates {
        ...
        private static String proSellerInquiry(String baseUrl, long productId, String productName, String type,
                String message,
            ...
            return """
                    ...
                    """
                    .formatted(logoCid, escape(productName), escape(buyerName), escape(buyerEmail), escape(buyerEmail),
                            escape(phone), escape(type), escape(message), baseUrl, productId);
        }

        private static String buyerConfirmation(String baseUrl, String productName, String type, String message,
                String logoCid) {
            return """
                    <!DOCTYPE html>
                    <html>
