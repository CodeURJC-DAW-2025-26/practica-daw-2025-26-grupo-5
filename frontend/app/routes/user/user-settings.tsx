      ...
      <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    {[...Array(5)].map((_, i) => (
                      <i
                        ...
                        className={`fa-solid fa-star ${
                          i < Math.floor(user.rating || 0) ? 'text-warning' : 'text-muted'
                        }`}
            ...
            <Col md={6}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  maxLength={4}
                />
                <small className="text-muted">3-4 digits on back</small>
              </Form.Group>
            </Col>
          </Row>
        </div>
        ...
        <div className="clay-card p-4 p-md-5 shadow-sm mb-4 rounded-4">
          ...
          <Row className="g-4">
            ...
            <Col md={12}>
              <Alert variant="info" className="rounded-3 d-flex align-items-start gap-3 mb-0">
                <i className="fa-solid fa-shield fa-lg mt-1" style={{ color: '#2f6ced' }}></i>
                <div>
                  <strong>Secure Delivery:</strong> Your QR code ensures only the verified seller can authorize final delivery and release payment.
                </div>
              </Alert>
            </Col>
          </Row>
        ...
        {/* Submit Button */}
        <div className="clay-card p-4 shadow-sm d-flex gap-3">
          <button
            type="submit"
            disabled={loading}
            className="btn-about py-3 px-4 d-flex align-items-center gap-2"
          >
            {loading ? (
              <>
            ...
            <Col md={6}>
              <Form.Group>
                ...
                <Form.Control
                  ...
                  value={formData.cardExpiringDate}
                  onChange={handleInputChange}
                  className="search-box"
                  disabled={loading}
                  placeholder="MM/YY"
